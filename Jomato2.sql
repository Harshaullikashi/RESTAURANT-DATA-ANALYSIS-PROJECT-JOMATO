...
count of customers in each region who have done the transaction in the year 2020.
...
group by region_ID
 ...
 maximum and minimum transaction amount of each transaction type.
...
group by txn_type 
 ...
 customer id, region name and transaction amount where transaction type is deposit and transaction amount > 2000.
...
duplicate records in the Customer table.
